...
// The Extension add toggle feature when tapping the item
// When selected the item, if the Set contains the element then remove
// else add it to the Set

extension Set where Element == Int  {
    mutating func toggleMatching<Item>(_ item: Item) where Item: Identifiable, Item.ID == Int {
